...
/* product Id  */
static char sg_product_id[MAX_SIZE_OF_PRODUCT_ID + 1]	 = "0WUKPUCOTC";//"PRODUCT_ID";

/* device name */
static char sg_device_name[MAX_SIZE_OF_DEVICE_NAME + 1]  = "dev001";//"YOUR_DEV_NAME";

#ifdef DEV_DYN_REG_ENABLED
/* product secret for device dynamic Registration  */
static char sg_product_secret[MAX_SIZE_OF_PRODUCT_SECRET + 1]  = "N6B8M91PB4YDTRCpqvOp4w==";//"YOUR_PRODUCT_SECRET";
#endif
...
static char sg_device_secret[MAX_SIZE_OF_DEVICE_SECRET + 1] = "N6B8M91PB4YDTRCpqvOp4w==";//"YOUR_IOT_PSK";
#endif
